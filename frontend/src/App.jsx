      ...
      <div className="calendar-grid">
        ...
        {daysArray.map((day) => {
          ...
          const dayData = monthData.find(
            (data) => new Date(data[0]).toDateString() === date.toDateString()
          );
          const incompleteNotesCount = dayData
            ? dayData[1].notes.filter((note) => !note.isCompleted).length
            : 0;
          ...
          return (
            ...
            >
              ...
              {incompleteNotesCount > 0 && (
                <span className="note-count-indicator">
      ...
      <div id="day-detail">
        ...
        <div className="on-this-day">
          ...
          {onThisDay && onThisDay.length > 0 ? (
            <div>
              <p>
                {onThisDay[0].title || "No title"} (
                {onThisDay[0].year?.toString() || "No year"})
              </p>
              <a
                href={onThisDay[0].wikiLink || "#"}
                target="_blank"
